...
| Control-tower UX (`CTL-01`)                        | Implemented locally     | Implemented / Not Run              | Five-lens summary SQL, bounded pagination and exact allocation aggregation are corrected; authenticated runtime smoke passed 5/5, while authored suites remain not run                                                                               |
