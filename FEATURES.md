...
| Jurigari production demo profile (`JURIGARI-DEMO`) | Implemented locally | Focused Passing       | Explicit idempotent/adoptable `JG` profile, two protected Tenant Owners, workbook chain, immutable exact finance reconciliation, and secret-free verifier; 12 unit, 2 PostgreSQL integration, and 2 Chromium cases pass |
