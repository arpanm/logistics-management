...
| MST-01/MST-02/MST-03 | Adopt the completed PostgreSQL PIN resolver/address component in organization, client-location, vendor, and driver forms; do not ask for city/state separately | Pending implementation   | FND-01 tenant provisioning passes `E2E-FND01-PIN-01`; each master feature owns its form migration and E2E evidence  |
| MST-01/MST-02/MST-03 | Define an audited unknown-PIN exception policy, if operations require one; keep free-text city/state blocked until that policy is approved                     | Pending product decision | FND-01 returns actionable not-found/retry and deliberately creates no inconsistent manual address                   |
