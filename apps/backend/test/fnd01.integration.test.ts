  ...
  () => {
    ...
    it("FND01-A-006: every live tenant table has forced RLS, a policy, tenant-leading index and declared nullability", async () => {
      const expected: Record<string, boolean> = {
        ...
        "app.accounting_reconciliation_entries": false,
        "app.alert_rule_evaluations": false,
        "app.allocation_assignments": false,
        "app.allocations": false,
        "app.api_clients": false,
        "app.approval_decisions": false,
        "app.approval_definitions": false,
        "app.approval_instances": false,
        "app.client_invoice_lines": false,
        "app.client_invoices": false,
        "app.client_locations": false,
        "app.client_rate_lines": false,
        "app.clients": false,
        "app.collection_followups": false,
        "app.compliance_records": false,
        "app.configuration_projection_versions": false,
        "app.configuration_versions": false,
        "app.contract_change_notes": false,
        "app.contract_lanes": false,
        "app.contract_versions": false,
        "app.contracts": false,
        "app.document_access_tokens": false,
        ...
        "app.governed_document_versions": false,
        "app.governed_documents": false,
        "app.gps_device_observations": false,
        "app.idempotency_records": true,
        "app.import_errors": false,
        "app.import_jobs": false,
        "app.import_rows": false,
        "app.indent_cancellations": false,
        "app.indents": false,
        "app.integration_delivery_attempts": false,
        "app.integration_mapping_versions": false,
        "app.integration_dead_letters": false,
        "app.integration_deliveries": false,
        "app.integration_endpoints": false,
        "app.job_runs": true,
        "app.invitation_delivery_attempts": false,
        ...
        "app.payment_allocations": false,
        "app.payment_batches": false,
        "app.pod_invoice_links": false,
        "app.pod_tasks": false,
        "app.receipt_ledger_entries": false,
        "app.receipts": false,
        ...
        "app.trip_events": false,
        "app.trips": false,
        "app.vehicles": false,
        "app.vendor_bank_versions": false,
        "app.vendor_bill_lines": false,
        "app.vendor_bills": false,
        "app.vendor_service_scopes": false,
        "app.vendors": false,
        "app.webhook_events": false,
        "app.notification_deliveries": false,
        "app.notification_delivery_attempts": false,
