...
The original FND-01 suite and expanded cross-feature acceptance case `E2E-FOUND-FND01-05` pass. The platform report now derives totals and tenant rows from one PostgreSQL snapshot, including under concurrent tenant provisioning.
